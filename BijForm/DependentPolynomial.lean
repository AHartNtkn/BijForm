...
def castFiberChild {P : DepPoly ι} {Code : ι → Type u} {i : ι}
    {f g : Fiber P i} (h : f = g)
...
def fiberObjCodeLayerInv {P : DepPoly ι} {Code : ι → Type u} {i : ι}
...
/--
Generated one-step coding data. The caller supplies an output-index inversion
and a coding of the resulting local layer; the full `Obj P Code i ≃ᵢ Code i`
step is generated by composing with `objCodeLayerIso`.
-/
structure GeneratedLayerCode
    (P : DepPoly ι)
    (Code : ι → Type u) where
...
namespace GeneratedLayerCode

variable {P : DepPoly ι} {Code : ι → Type u}

def step (C : GeneratedLayerCode P Code) (i : ι) :
    Obj P Code i ≃ᵢ Code i :=
  Iso.trans (objCodeLayerIso C.inversion Code i) (C.layer i)

def toWellFoundedCode (C : GeneratedLayerCode P Code) :
...
def iso (C : GeneratedLayerCode P Code) (i : ι) : Mu P i ≃ᵢ Code i :=
